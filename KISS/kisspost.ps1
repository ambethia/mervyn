        ...
        switch ($match.Groups[1].Value) {
            ...
            Perimeter {
                if ($global:currentAccl -ne $perimeterPathAccl) {
                    $match.Groups[0].Value -replace $match.Groups[3].Value, ("SET_VELOCITY_LIMIT ACCEL={0} ACCEL_TO_DECEL={0} SQUARE_CORNER_VELOCITY=4`n{1}" -f $perimeterPathAccl, $match.Groups[3].Value);
